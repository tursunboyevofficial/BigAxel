...
export const uz = {
  ...
  apply: {
    ...
    placeholders: {
      ...
      cv: 'Yuklang: .pdf, .doc, .docx, .txt yoki .rtf',
      portfolio: 'https://',
    ...
    errors: {
      ...
      resumeType: 'Faqat .pdf, .doc, .docx, .txt, .rtf formatlari qabul qilinadi.',
      resumeSize: 'Rezyume hajmi 100 MB dan katta bo‘lmasin.',
